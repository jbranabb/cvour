        ...
        <section className='w-screen min-h-screen text-white font-bold'>
            <div className='flex flex-col p-10 h-screen '>
                ...
                <ul className="mt-3 space-y-2 text-sm font-medium text-gray-300">
                    ...
                    <li className='flex gap-2 items-center'><MdPhoneIphone size={30} /> Scalable & future-proof technology that grows with your business</li>
                ...
                <div className="flex flex-col pt-8 gap-4">
                    ...
                    flex flex-row gap-4 items-center p-6 hover:bg-white/20 transition-all hover:border-white/25">
                      <SiAndroid size={80} />
