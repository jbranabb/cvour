    ...
    <section className='w-screen min-h-screen xl:min-h-0 xl:mb-60 p-0 mt-25 md:mt-30 lg:mt-0'>
      <div className="gap-10 sm:px-10 xl:px-0">
        <div className="p-6 2xl:px-12">
          <h1 className="text-white text-2xl font-extrabold sm:text-3xl md:text-5xl">What We’ve Been Building</h1>
          <p className="font-medium text-white text-sm sm:text-lg md:text-2xl">Take a peek at our latest digital experiments and creative builds.</p>
        </div>
          {loading ?
